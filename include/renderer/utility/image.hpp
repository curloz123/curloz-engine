...
namespace clz::renderer
{
	 ...
	 */
	bool createImage(VkImage& rImage, const std::string& name, uint32_t width, uint32_t height, VkFormat format,
	 ...
	 * @return True if successful, false if not
	 */
	bool createImageView(VkImageView& rImageView, const std::string& name, VkImage image, VkFormat format,
