...
/// 1. Their bind point in shader, make sure to make them constexpr and name them as
/// ${NAME_OF_UBO}_UBO_BINDPOINT.
...
///
/// All the "pipeline-specific" uniform buffers, such as shape pipeline's seperate camera ubo
/// etc. go at the bottom, also their update function should be managed seperately.
